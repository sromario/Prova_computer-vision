"""
a) Carregue uma imagem ou utilize a webcam para capturar um frame.
b) Implemente um algoritmo de detecção de contornos para identificar objetos na
imagem.
c) Desenhe retângulos ao redor dos objetos detectados.
d) Exiba a imagem resultante com os retângulos desenhados
"""
...
imgClose = cv2.morphologyEx(imgcanny,cv2.MORPH_CLOSE,(7,7))#morfologia de closing\
#para ter um fechamento melhor de cada objeto

contornos,hierarquia = cv2.findContours(imgClose,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_NONE)
#separar os contornos dando as cordenadas dos contornos
